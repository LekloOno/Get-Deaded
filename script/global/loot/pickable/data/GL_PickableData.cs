...
public abstract partial class GL_PickableData : Resource 
{
    ...
    protected abstract GL_PhysicsPickable GetPhysicsPickable(float horizontalDamp);
    public GL_PhysicsPickable GeneratePhysics(float horizontalDamp)
    {
        GL_PhysicsPickable pickable = GetPhysicsPickable(horizontalDamp);
