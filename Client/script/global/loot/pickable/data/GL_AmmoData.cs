...
public partial class GL_AmmoData : GL_PickableData
{
    ...
    protected override GL_PhysicsPickable GetPhysicsPickable(float horizontalDamp, float lifeTime) => new (new GL_AmmoPickHandler((GL_AmmoData) Duplicate()), horizontalDamp, lifeTime);
}