...
public partial class E_BasicEnemyMaterial : E_EnemyMaterial
{
    ...
    public float Alpha
	{
		...
		set
		{
			...
			_jointMesh.SetInstanceShaderParameter("alpha_override", value);
		}
	}
    ...
    public float OutlinesAlpha
    {
		...
		set
		{
			...
			_jointMesh.SetInstanceShaderParameter("outlines_alpha_override", value);
            _surfaceMesh.SetInstanceShaderParameter("xray_alpha_override", value);
            _jointMesh.SetInstanceShaderParameter("xray_alpha_override", value);
		}
    }
    ...
    private bool CheckSetup()
    {
        ...
        if(_jointMesh.MaterialOverride is not Material jtMat)
        {
